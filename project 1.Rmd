...
hist(Life.exp.rate_2022, col = 'orange', main = "", freq = TRUE, xlim =c(0,120) , ylim = c(0,35), xlab = "Life Expectancy in Both Sexes",  breaks = 15 )
...
plot8 <- ggplot(life.exp.both, aes(life.exp, Region, fill=Region)) + geom_boxplot() + coord_flip() + labs(y= "Regions", x= "Life.Expectancy.at.Birth..Both.Sexes")
```
...
plot7 <- ggplot(mor.both, aes(Mortality, Region, fill=Region)) + geom_boxplot() + coord_flip() + labs(y= "Regions", x= "Under.Age.5.Mortality..Both.Sexes")
...
plot9 <- ggplot(life.exp.males, aes(life.exp, Region, fill=Region)) + geom_boxplot() + coord_flip() + labs(y= "Regions", x= "Life.Expectancy.at.Birth..Males")
```
...
plot10 <- ggplot(life.expectancy.females, aes(Mortality, Region, fill=Region)) + geom_boxplot() + coord_flip() + labs(y= "Regions", x= "Life.Expectancy.at.Birth..Females")
...
plot11 <- ggplot(mor.males, aes(Mortality, Region, fill=Region)) + geom_boxplot() + coord_flip() + labs(y= "Regions", x= "Under.Age.5.Mortality..Males")
```
...
plot12 <- ggplot(mor.females, aes(Mortality, Region, fill=Region)) + geom_boxplot() + coord_flip() + labs(y= "Regions", x= "Under.Age.5.Mortality..Females")
...
colnames(plot) <- c("Life Expectancy Both Sexes", "Life Expectancy Males", "Life Expectancy Females", "Mortality Both Sexes", "Mortality Males", "Mortality Females")
rownames(plot) <- c("Life Expectancy Both Sexes", "Life Expectancy Males", "Life Expectancy Females", "Mortality Both Sexes", "Mortality Males", "Mortality Females")
